...
WATSON_USERNAME = "f01bbac7-edf8-4169-90e9-bc107346d727"
WATSON_PASSWORD = "5COdEfEqFJlD"
...
class rebreakcaptcha(object):
    def __init__(self):
        ...
        # self.driver.get('http://www.cualesmiip.com/')
    ...
    def speech_to_text(self, audio_source):
        ...
        try:
            ...
            # print("Using watson")
            # audio_output = recognizer.recognize_ibm(audio, username=WATSON_USERNAME, password=WATSON_PASSWORD)
            # print("[{0}] WATSON Recognition: ".format(self.current_iteration) + audio_output)
            ...
            if any(character.isalpha() for character in audio_output):
                ...
                audio_output = self.string_to_digits(recognizer.recognize_ibm(audio, username=WATSON_USERNAME, password=WATSON_PASSWORD))
                # print("[{0}] WATSON: ".format(self.current_iteration) + audio_output)
